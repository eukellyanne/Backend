...
public class AlunoService {
    ...
    public void atualizarAlunoPorId(Long id, Aluno aluno) {
        ...
        //SE CHEGAR AQUI, SIGNIFICA QUE EXISTE ALUNO, ENTÃO VOU ARMAZENÁ-LO EM UMA VARIÁVEL
        Aluno alunoEditado = alunoDoBancoDeDados.get();

        //COM ESSE ALUNO EDITADO DE CIMA, FAÇO OS SETS NECESSÁRIOS PARA ATUALIZAR OS ATRIBUTOS DELE.
        alunoEditado.setNome(aluno.getNome());
        alunoEditado.setCpf(aluno.getCpf());
        alunoEditado.setEmail(aluno.getEmail());

        //COM O ALUNO TOTALMENTE EIDTADO ACIMA, EU DEVOLVO ELE EDITADO/ATUALIZADO PARA O BANCO DE DADOS
